...
- [tasksDialog.test](dialogs/tasksDialog.test.js) shows how to write a data driven test using a `bookingDialogTestCases` module to generate the test cases.
- [mainDialog.test](dialogs/mainDialog.test.js) showcases how to use mock objects to mock the dialog's LUIS and `TasksDialog` dependencies to test `MainDialog` in isolation.
