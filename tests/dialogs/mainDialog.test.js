...
const { TasksDialog } = require('../../dialogs/tasksDialog');
 ...
 */
class MockBookingDialog extends TasksDialog {
    constructor() {
        super('tasksDialog');
    }
...
/**
* A specialized mock for TasksDialog that displays a dummy TextPrompt.
...
*/
class MockBookingDialogWithPrompt extends TasksDialog {
    constructor() {
        super('tasksDialog');
    }
...
describe('MainDialog', () => {
    ...
    describe('Invokes tasks based on LUIS intent', () => {
        ...
        const testCases = [
            { utterance: 'I want to book a flight', intent: 'BookFlight', invokedDialogResponse: 'tasksDialog mock invoked', taskConfirmationMessage: 'I have you booked to Seattle from New York' },
        ...
        testCases.map(testData => {
            it(testData.intent, async () => {
                ...
                const tasksDialog = new MockBookingDialog();
                const sut = new MainDialog(mockRecognizer, tasksDialog);
                const client = new DialogTestClient('test', sut, null, [new DialogTestLogger()]);
    ...
    describe('Shows unsupported cities warning', () => {
        ...
        const testCases = [
            ...
            { jsonFile: 'FlightFromParisToNewYork.json', expectedMessage: 'tasksDialog mock invoked' }
        ];
